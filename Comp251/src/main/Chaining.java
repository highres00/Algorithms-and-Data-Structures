...
public class Chaining {
    ...
    public int chain (int key) {
        ...
        return ((int)((A*key)%power2(w)))>>(w-r);// implement function provided in the pdf
//        return -1;
    }
    ...
    public int insertKey(int key){
        //TODO: implement this and change the return statement
//        int count=0;
//        if (Table.get(chain(key)).size() == 0) {
//            count=0;
//            Table.get(chain(key)).add(key);
//            //return 0;
//        } else {
//            count=Table.get(chain(key)).size();
...
//        ArrayList<Integer> x;
//       //ArrayList<Integer>
//                x=Table.get(chain(key));
//        x.add(key);
//        return (x.size()-1);

        Table.get(chain(key)).add(key);
        return Table.get(chain(key)).size()-1;
